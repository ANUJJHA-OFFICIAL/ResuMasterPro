      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400">Manage and edit all your professional resumes.</p>
          </div>
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="w-full rounded-2xl border border-slate-200 bg-white py-4 pl-12 pr-4 text-slate-900 outline-none transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 dark:border-slate-800 dark:bg-slate-900 dark:text-white dark:focus:border-blue-400"
            value={searchQuery}
        ...
        {filteredResumes.length > 0 ? (
                ...
                <div className="p-5 bg-white dark:bg-slate-900">
                  <div className="mb-3 flex items-start justify-between">
                    <div className="min-w-0">
                      <h3 className="truncate font-bold text-slate-900 dark:text-white" title={resume.title}>{resume.title}</h3>
                      <p className="truncate text-xs text-slate-500 dark:text-slate-400 font-medium">{resume.role}</p>
                    </div>
                    <div className="relative">
                      <button 
                  ...
                  <div className="flex items-center justify-between border-t border-slate-100 dark:border-slate-800 pt-3">
                    ...
                    <div className="flex gap-1">
                      <button 
                        className="rounded-lg p-1.5 text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-blue-600 dark:hover:text-blue-400" 
                        title="Edit"
                        onClick={() => navigate(`/builder/role?role=${resume.role}&resumeId=${resume.id}`)}
                      >
          ...
          <Card className="flex flex-col items-center justify-center p-12 text-center">
            ...
            <p className="mb-8 max-w-sm text-slate-500 dark:text-slate-400">
              {searchQuery ? 'Try a different search term or clear the filter.' : 'Create your first professional resume in minutes with our smart builder.'}
            </p>
            {!searchQuery && (
              <Link to="/builder/role">
                <Button>
